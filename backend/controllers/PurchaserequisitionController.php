...
use Yii;
use common\models\Purchaserequisition;
...
$LineNo=10000;
        ...
        for($i=0;$i<=5;$i++)
        {
            ...
            $item_type =   '<select style="width:100%" name="lines_'.$i.'_Type" onchange="filterOptions(this)">'.
            ...
            $channel[] = array(
                    ...
                    '<input type="text" width="100%" name="lines_'.$i.'_Quantity" onkeyup="onQuantityInputBlur(this)"></input>',
                    '<input type="text" width="100%" id="lines_'.$i.'_UnitPrice" name="lines_'.$i.'_UnitPrice" onblur="onUnitPriceInputBlur(this)" disabled></input>',
...
$LineNo=10000;
        ...
        $model['Employee Name'] = Yii::$app->user->identity->LastName . ", "
         ...
         $model['No_'] =  'PR' . $nextRequisitionNo; 
         // str_pad(
         //        substr(
         //            implode("", 
         //                Purchaserequisition::find()->select(['TOP 1 [No_]'])->orderBy(['[No_]' => SORT_DESC ])->asArray()->one()
